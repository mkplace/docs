...
<Note>
  O corpo acima é ilustrativo. Os campos completos e obrigatórios seguem a especificação do contrato — a **Referência da API** com o schema definitivo será publicada nesta seção.
</Note>

{/* TODO(ref-openapi): substituir o link acima pela página de referência OpenAPI do contrato GET/PUT /customer/profile quando os specs forem importados. */}

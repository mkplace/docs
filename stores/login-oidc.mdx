...
Este é um dos **métodos de autenticação** da integração de Lojas: o login
**de usuário** no navegador usando OpenID Connect (OIDC) com o fluxo
**Authorization Code + PKCE** contra o Keycloak da Mkplace. É uma alternativa ao modelo de
